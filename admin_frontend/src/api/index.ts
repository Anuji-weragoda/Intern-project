...
const API_BASE =
  // Prefer Vite-provided env when running in the browser build (import.meta.env)
  ((typeof import.meta !== 'undefined' ? (import.meta as any)?.env?.VITE_API_BASE_URL : undefined) as string | undefined) ||
